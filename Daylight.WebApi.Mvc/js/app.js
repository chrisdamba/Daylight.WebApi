		...
		function nav_page_height() {
			...
			if (setHeight > windowHeight){ // if content height exceedes actual window height and menuHeight
				...
				$.root_.css('min-height', setHeight + 49 + 'px');  //new line
		...
		function runBootstrapWizard() {
		    ...
		    var $validator = $("#wizard-1").validate({
		        ...
		        messages: {
		            fname: "Please specify patient first name",
		            lname: "Please specify patient last name",
		            email: {
		                required: "Email address is needed to contact patient",
