...
PatientCreateView = (function(_super) {
  ...
  PatientCreateView.prototype.save = function() {
    var address, areaLocality, building, city, collection, dob, email, fname, form, gender, lname, phone, prefix, province, relationshipStatus, street,
      _this = this;
    ...
    areaLocality = this.$('#areaLocality').val();
    building = this.$('#building').val();
    street = this.$('#street').val();
    city = this.$('#street').val();
...
module.exports = function (__obj) {
  ...
  (function() {
    (function() {
      ...
      __out.push(__sanitize(this.getSafeDateRegistered()));
