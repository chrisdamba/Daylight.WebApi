...
PatientCreateView = (function(_super) {
  ...
  PatientCreateView.prototype.save = function() {
    var address, areaLocality, building, city, collection, dob, email, fname, form, gender, lname, phone, prefix, province, rstatus, street, _model;
    ...
    (function() {
      ...
      if ((_ref = this.medications) != null ? _ref.length : void 0) {
        ...
        for (_i = 0, _len = _ref1.length; _i < _len; _i++) {
          ...
          __out.push('</span>\n\t\t\t<ul role="group">\n\t\t\t\t<li style="display: none;">\n\t\t\t\t\t<span><i class="fa fa-clock-o"></i> 8.00</span> &ndash; <a href="#">');
          __out.push(__sanitize(med.startedAt));
          __out.push('</a>\n\t\t\t\t</li>\n\t\t\t</ul>\n\t\t</li>    \n\t');
        }
        __out.push('\n\t</ul>\n');
      }
