...
PatientCreateView = (function(_super) {
  ...
  PatientCreateView.prototype.events = {
    ...
    'click .js-next-btn': 'onWizardNextClick',
  ...
  PatientCreateView.prototype.save = function() {
    ...
    relationshipStatus = this.$("input:radio[name ='relationshipStatus']:checked").val();
  ...
  PatientCreateView.prototype.onWizardNextClick = function(e) {
    e.preventDefault();
    return this.runBootstrapWizard();
  };
